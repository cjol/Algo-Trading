...
public class OrderBookReconstructorResult {
	...
	public OrderBookReconstructorResult(Map<StockHandle, Map<Integer, PriceLevel<BuyOrder>>> stockBids,
			Map<StockHandle, Map<Integer, PriceLevel<SellOrder>>> stockOffers) {
		this.stockBids = stockBids;
		this.stockOffers = stockOffers;
	}
	
	public Map<StockHandle, Map<Integer, PriceLevel<BuyOrder>>> getBidsMap() {return stockBids;}
	public Map<StockHandle, Map<Integer, PriceLevel<SellOrder>>> getOffersMap() {return stockOffers;}
