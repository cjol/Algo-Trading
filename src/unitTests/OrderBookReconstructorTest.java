...
public class OrderBookReconstructorTest {
	...
	private List<Order> getMultiplePriceLevelsTestData() {
		...
		//Book: Buy 15 at 100
		testOrders.add(new BuyOrder(null, new Timestamp(100), new BigDecimal(100), 15));
		//Book: Buy 15 at 100, sell 10 at 101
		testOrders.add(new SellOrder(null, new Timestamp(200), new BigDecimal(101), 10));
		//Book: Buy 15 at 100, sell 5 at 101 (5 from buy at 102 and sell at 101 were matched)
		testOrders.add(new BuyOrder(null, new Timestamp(300), new BigDecimal(102), 5));
		//Book: Buy 5 at 100, sell 5 at 101 (10 from buy and sell at 100 were matched)
		testOrders.add(new SellOrder(null, new Timestamp(400), new BigDecimal(100), 10));
		//Book: Buy 5 at 100, sell 5 at 101, sell 10 at 102
		testOrders.add(new SellOrder(null, new Timestamp(500), new BigDecimal(102), 10));
		//Book: Buy 5 at 100, buy 10 at 101, sell 10 at 102 (5 from buy and sell at 101 were matched)
		testOrders.add(new BuyOrder(null, new Timestamp(600), new BigDecimal(101), 15));
		//Book: sell 10 at 102 (sell 15 at 10 was matched with 5@100 and 10@101)
		testOrders.add(new SellOrder(null, new Timestamp(700), new BigDecimal(10), 15));
	...
	private boolean hasVolumePrice(Iterator<? extends Order> orders, int volume, int price) {
		while (orders.hasNext()) {
			Order o = orders.next();
			if (o.getVolume() == volume && o.getPrice().intValue() == price) {
				return true;
			}
		}
		return false;
