...
public class OrderBookReconstructorTest {
	...
	public void testBasicMatching() {
		...
		OrderBookReconstructorResult result1 = reconstructor.getOrderBookAt(new Timestamp(100));
		...
		OrderBookReconstructorResult result2 = reconstructor.getOrderBookAt(new Timestamp(1000));
	...
	public void testPartialFill() {
		...
		OrderBookReconstructorResult result1 = reconstructor.getOrderBookAt(new Timestamp(700));
		...
		OrderBookReconstructorResult result2 = reconstructor.getOrderBookAt(new Timestamp(1100));
		assertTrue(result2.getBidsMap().isEmpty());
		assertTrue(result2.getOffersMap().isEmpty());
	}
	...
	public void testMultiplePriceLevels() {
		...
		OrderBookReconstructorResult result1 = reconstructor.getOrderBookAt(new Timestamp(150));
		assertTrue(result1.getBidsMap().get(100).getOrders().peek().getVolume() == 15);
		
		OrderBookReconstructorResult result2 = reconstructor.getOrderBookAt(new Timestamp(250));
		...
		OrderBookReconstructorResult result3 = reconstructor.getOrderBookAt(new Timestamp(350));
		...
		OrderBookReconstructorResult result4 = reconstructor.getOrderBookAt(new Timestamp(450));
		...
		OrderBookReconstructorResult result5 = reconstructor.getOrderBookAt(new Timestamp(550));
		...
		OrderBookReconstructorResult result6 = reconstructor.getOrderBookAt(new Timestamp(650));
		...
		OrderBookReconstructorResult result7 = reconstructor.getOrderBookAt(new Timestamp(750));
